...
|---|---|---|---|---|---|
| **D1. Capacity estimation** ★ (AB note `01`/`02`/`10`/`13`) | DR-14 | Partial | Documented (never load-tested) | `SYSTEM_DESIGN_DECISIONS.md:297-334` (10K/30K msg/s, 30-40 shards, 12-15 TB/yr); honesty caveat `:330`; `EXPERIENCE_REPORT.md:73`; `PLATFORM_BOOK.md:341` | Top remediation (b)5: one committed local load-test transcript for `/v1/score-ais` + one measured $/inference |
